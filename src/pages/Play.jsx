...
export default function PlayPage() {
  const { game, joinTeam, touchTeamSession, submitAnswer, rollDice } = useGameEngine();
  ...
  }, [game.phase, game.opening?.questionIndex, game.minigame?.questionIndex, game.opening?.startedAt, game.minigame?.startedAt]);
